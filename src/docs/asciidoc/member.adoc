...
*HTTP Request*
include::{snippets}/member-controller-test/get-member-profile/http-request.adoc[]

*HTTP Response*
include::{snippets}/member-controller-test/get-member-profile/http-response.adoc[]

* Response Fields
include::{snippets}/member-controller-test/get-member-profile/response-fields.adoc[]